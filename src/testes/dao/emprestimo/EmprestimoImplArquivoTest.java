...
class EmprestimoImplArquivoTest {
    ...
    void criar() {
        ...
        Emprestimo emprestimoEsperado = new Emprestimo(livroEsperado.getISBN(), leitorEsperado.getID());
    ...
    void encontrarHistoricoDeUmLeitor() {
        ...
        DAO.getEmprestimo().criar(new Emprestimo(13.00000,1000));
        DAO.getEmprestimo().criar(new Emprestimo(14.00000,1000));
        DAO.getEmprestimo().criar(new Emprestimo(14.00000,1000));
    ...
    void encontrarHistoricoDeUmLivro() {
        ...
        DAO.getEmprestimo().criar(new Emprestimo(11.00000,1300));
