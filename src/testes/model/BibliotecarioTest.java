...
class BibliotecarioTest {
    ...
    void fazerEmprestimo() throws ObjetoInvalido, LeitorBloqueado, LeitorMultado, LeitorTemEmprestimo, LivroEmprestado, LivroReservado, LivroNaoDisponivel {
        ...
        assertThrows(LeitorBloqueado.class, ()-> this.bibliotecario1.fazerEmprestimo(1003,livro1.getISBN()));
        ...
        DAO.getLeitor().atualizar(leitor1);
        assertThrows(LeitorMultado.class, ()-> this.bibliotecario1.fazerEmprestimo(1003,livro1.getISBN()));
        leitor1.setDataMulta(null);
        DAO.getLeitor().atualizar(leitor1);

        //livro nao ta disponivel porque está emprestado a outro leitor
        livro1.setDisponivel(false);
        DAO.getLivro().atualizar(livro1);
        ...
        assertThrows(LivroEmprestado.class, ()-> this.bibliotecario1.fazerEmprestimo(1003,livro1.getISBN()));

        //livro nao ta disponivel porque o adm alterou sua disponibilidade (livro em reparo ou algo do tipo)
        DAO.getEmprestimo().removerTodos();
        livro1.setDisponivel(false);
        DAO.getLivro().atualizar(livro1);
        assertThrows(LivroNaoDisponivel.class, ()-> this.bibliotecario1.fazerEmprestimo(1003,livro1.getISBN()));
        ...
        assertThrows(LeitorTemEmprestimo.class, ()-> this.bibliotecario1.fazerEmprestimo(1003,livro1.getISBN()));
        DAO.getEmprestimo().removerTodos();
        ...
        assertThrows(LivroReservado.class, ()-> this.bibliotecario1.fazerEmprestimo(1003,livro1.getISBN()));
        DAO.getReserva().removerTodos();
        ...
        this.bibliotecario1.fazerEmprestimo(1003,livro1.getISBN());
